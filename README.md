## bcr_bot (jazzy) - 2.0.0-2

The packages in the `bcr_bot` repository were released into the `jazzy` distro by running `/home/devanshu/.local/bin/bloom-release --rosdistro jazzy --track jazzy bcr_bot --edit` on `Wed, 26 Nov 2025 09:49:44 -0000`
